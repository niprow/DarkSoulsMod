...
public class TileEntityTypeRegistry {
    ...
    public static final TileEntityType<BonfireTileEntity> BONFIRE_TILE_ENTITY_TYPE = register(Constants.BONFIRE, new TileEntityType<BonfireTileEntity>(BonfireTileEntity::new, (Set<Block>) BlockRegistry.BONFIRE, null));
